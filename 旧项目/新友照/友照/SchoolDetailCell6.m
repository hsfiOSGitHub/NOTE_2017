...
@implementation SchoolDetailCell6

//科二
-(void)setSchoolDetailModel_2:(SchoolDetailModel *)schoolDetailModel_2
{
    _schoolDetailModel_2 = schoolDetailModel_2;
    //配置数据
    NSArray *iconImageArr = schoolDetailModel_2.teacher_subject2;
