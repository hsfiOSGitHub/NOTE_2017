...
//
// Usage:
//    #include "UMOpenUDID.h"
//    NSString* openUDID = [UMOpenUDID value];
//

#define kUMOpenUDIDErrorNone          0
#define kUMOpenUDIDErrorOptedOut      1
#define kUMOpenUDIDErrorCompromised   2
