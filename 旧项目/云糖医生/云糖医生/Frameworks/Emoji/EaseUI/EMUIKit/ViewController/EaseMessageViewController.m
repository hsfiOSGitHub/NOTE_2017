...
- (void)viewDidLoad {
    ...
    [[EaseBaseMessageCell appearance] setSendMessageVoiceAnimationImages:@[[UIImage imageNamed:@"EaseUIResource.bundle/chat_sender_audio_playing_full"], [UIImage imageNamed:@"EaseUIResource.bundle/chat_sender_audio_playing_000"], [UIImage imageNamed:@"EaseUIResource.bundle/chat_sender_audio_playing_001"]]];
    [[EaseBaseMessageCell appearance] setRecvMessageVoiceAnimationImages:@[[UIImage imageNamed:@"EaseUIResource.bundle/chat_receiver_audio_playing_full"],[UIImage imageNamed:@"EaseUIResource.bundle/chat_receiver_audio_playing000"], [UIImage imageNamed:@"EaseUIResource.bundle/chat_receiver_audio_playing001"]]];
...
- (void)_sendMessage:(EMMessage *)message
{
    ...
    NSLog(@"%@",[ZXUD objectForKey:@"name"]);
    if ([[ZXUD objectForKey:@"name"] isKindOfClass:[NSString class]] && [[ZXUD objectForKey:@"name"] length]>0 && [[ZXUD objectForKey:@"pic"] isKindOfClass:[NSString class]] && [[ZXUD objectForKey:@"pic"] length]>0)
    {
        message.ext = @{@"nickName":[ZXUD objectForKey:@"name"],@"pic":[ZXUD objectForKey:@"pic"]};
    }
    else if ([[ZXUD objectForKey:@"name"] isKindOfClass:[NSString class]] && [[ZXUD objectForKey:@"name"] length]>0)
    {
        message.ext = @{@"nickName":[ZXUD objectForKey:@"name"]};
    }
    else if ([[ZXUD objectForKey:@"pic"] isKindOfClass:[NSString class]] && [[ZXUD objectForKey:@"pic"] length]>0)
    {
        message.ext = @{@"pic":[ZXUD objectForKey:@"pic"]};
    }
