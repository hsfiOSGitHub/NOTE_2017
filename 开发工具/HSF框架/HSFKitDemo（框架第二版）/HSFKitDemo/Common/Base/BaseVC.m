...
- (void)viewDidLoad {
    ...
    if (self.isFirstClass) {
        ...
        [self setBackIconWith:@"back_common"];
    }
...
-(UIButton *)menuBtn{
    if (!_menuBtn) {
        ...
        [_menuBtn setImage:[UIImage imageNamed:@"more_common"] forState:UIControlStateNormal];
...
-(NSMutableArray *)menuSource_icon{
    if (!_menuSource_icon) {
        _menuSource_icon = [NSMutableArray arrayWithArray:@[@"iphone", @"iphone"]];
    }
