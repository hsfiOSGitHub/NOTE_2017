...
-(void)awakeFromNib
{
    ...
    [self.likeButton setTitleColor:UMComColorWithHexString(UMCom_Micro_Feed_ButtonTitleCollor) forState:UIControlStateNormal];
    [self.forwardButton setTitleColor:UMComColorWithHexString(UMCom_Micro_Feed_ButtonTitleCollor) forState:UIControlStateNormal];
    [self.commentButton setTitleColor:UMComColorWithHexString(UMCom_Micro_Feed_ButtonTitleCollor) forState:UIControlStateNormal];
    ...
    self.dateLabel.textColor = UMComColorWithHexString(FontColorGray);
    ...
    self.dateLabel.textColor = UMComColorWithHexString(UMCom_Micro_Feed_DateColor);
    self.locationLabel.textColor = UMComColorWithHexString(UMCom_Micro_Feed_LocationCollor);
...
- (void)reloadDetaiViewWithFeedStyle:(UMComFeedStyle *)feedStyle viewWidth:(CGFloat)viewWidth
{
    ...
    if (originFeed) {
        ...
        self.originFeedBackgroundView.backgroundColor = UMComColorWithHexString(UMCom_Micro_Feed_ForwardBgCollor);
