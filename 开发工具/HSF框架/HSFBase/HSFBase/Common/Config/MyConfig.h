...
//>>>  基础配置 ： 颜色 字体大小  >>>
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#define k_themeColor kRGBColor(223, 74, 67) //kRGBColor(110, 110, 110)
#define k_bgViewColor_normal [UIColor groupTableViewBackgroundColor] //UIColorHex(0xf5f5f5)
#define k_fontColor_normal kRGBColor(39, 39, 39)

#define k_fontSize_1Class [UIFont systemFontOfSize:20]
...
//>>>>>>>>>>>>>>>>>>>>
/* 请求 域名地址  */
static NSString *kRequestHeaderUrl = @"http://schoolps.jzbwlkj.com";
static NSString *kRequsetBasePath = @"/api/service/carAdvert?";
static NSString *KIMAGEURLPathHost = @"http://192.168.1.20/cupboard/Uploads/";

/* 数据基本key */
static NSString *kRequsetDataKey = @"data";
static NSString *kRequsetStateKey = @"state";

static NSString *kRequsetCode = @"code";
static NSString *kRequsetMessage = @"msg";
