...
//黄山锋 添加的
-(void)replaceStarIconWithBackgroundIcon:(NSString *)backIconName ForegroundIcon:(NSString *)foreIconName{
    if (self.subviews.count > 0) {
        [self removeAllSubviews];
    }
    self.starBackgroundView = [self buidlStarViewWithImageName:backIconName];
    self.starForegroundView = [self buidlStarViewWithImageName:foreIconName];
