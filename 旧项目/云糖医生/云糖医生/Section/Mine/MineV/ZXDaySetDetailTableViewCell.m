...
@implementation ZXDaySetDetailTableViewCell
...
- (void)awakeFromNib {
    ...
    self.datePicker = [[UUDatePicker alloc]initWithframe:CGRectMake(0, 0, KScreenWidth, 216 *3/4) PickerStyle:UUDateStyle_HourMinute didSelected:^(NSString *year, NSString *month, NSString *day, NSString *hour, NSString *minute, NSString *weekDay) {
        _SetTextField.text = [NSString stringWithFormat:@"%@:%@",hour,minute];
    }];
    
    [backgroundview1 addSubview:_datePicker];
