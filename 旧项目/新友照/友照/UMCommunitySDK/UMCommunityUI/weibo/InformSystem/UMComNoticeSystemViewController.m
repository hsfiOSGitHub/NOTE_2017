...
- (void)viewDidLoad {
    ...
    tableView.backgroundColor = UMComColorWithHexString(UMCom_Forum_InfoCenter_TableView_BgColor);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 1:
        {
            UMComLikeTableViewController *likeListController = [[UMComLikeTableViewController alloc] init];
            vc = likeListController;
        }
            break;
        case 2:
        {
            UMComFeedTableViewController *hotPostListController = [[UMComFeedTableViewController alloc] init];
            [hotPostListController setTitleViewWithTitle:UMComLocalizedString(@"um_com_@me", @"@我")];
            
            UMComFeedBeAtDataController* feedListOfBeAtController = [[UMComFeedBeAtDataController alloc] initWithCount:UMCom_Limit_Page_Count];
            hotPostListController.dataController = feedListOfBeAtController;
            feedListOfBeAtController.isReadLoacalData = YES;
            feedListOfBeAtController.isSaveLoacalData = YES;
