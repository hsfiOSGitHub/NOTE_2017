...
//自己加的一个方法
- (void)setNormallColor {
    _backgroundLayer.fillColor = self.preferredNormalColor.CGColor;
}
- (void)setPreferredNormalColor:(UIColor *)preferredNormalColor {
    _backgroundLayer.fillColor = preferredNormalColor.CGColor;
}
