...
@implementation ZXCoachCalandarCell


- (void)awakeFromNib {
    [super awakeFromNib];
    //设置圆角
    _keman.layer.masksToBounds = YES;
    _keman.layer.cornerRadius = 10.0;
    _keyue.layer.masksToBounds = YES;
    _keyue.layer.cornerRadius = 10.0;
}
