...
- (void)viewDidLoad {
    ...
    self.dataController = [[UMComTopicsAllDataController alloc] initWithCount:UMCom_Limit_Page_Count];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableView* searchtableview = self.searchDisplayController.searchResultsTableView;
    if (tableView != searchtableview)  {
        [cell setWithTopic:self.dataController.dataArray[indexPath.row]];
    }
    else
    {
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    // 谓词搜索
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF.name CONTAINS[c] %@",searchString];
    self.filterData =  [[self.dataController.dataArray filteredArrayUsingPredicate:predicate] mutableCopy];
