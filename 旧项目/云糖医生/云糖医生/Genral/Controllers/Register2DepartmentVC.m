...
@interface Register2DepartmentVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation Register2DepartmentVC
#pragma mark -懒加载
-(NSArray *)source{
    if (!_source) {
...
-(void)okAction{
    ...
    [ValueHelper sharedHelper].registerDepartment = dict;
    [self.navigationController popViewControllerAnimated:YES];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //配置titleLabel
    cell.titleLabel.text = self.source[indexPath.row][@"name"];
